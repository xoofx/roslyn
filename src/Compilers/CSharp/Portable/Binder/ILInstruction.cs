...
//new ILInstruction(ILOpCode.EndFault, "endfault", OpCodeArg.None),
            ...
            new ILInstruction(ILOpCode.Ldarg_0, "ldarg_0", OpCodeArg.None),
            new ILInstruction(ILOpCode.Ldarg_1, "ldarg_1", OpCodeArg.None),
            new ILInstruction(ILOpCode.Ldarg_2, "ldarg_2", OpCodeArg.None),
            new ILInstruction(ILOpCode.Ldarg_3, "ldarg_3", OpCodeArg.None),
            ...
            new ILInstruction(ILOpCode.Ldc_i4_0, "ldc.i4_0", OpCodeArg.None),
            new ILInstruction(ILOpCode.Ldc_i4_1, "ldc.i4_1", OpCodeArg.None),
            new ILInstruction(ILOpCode.Ldc_i4_2, "ldc.i4_2", OpCodeArg.None),
            new ILInstruction(ILOpCode.Ldc_i4_3, "ldc.i4_3", OpCodeArg.None),
            new ILInstruction(ILOpCode.Ldc_i4_4, "ldc.i4_4", OpCodeArg.None),
            new ILInstruction(ILOpCode.Ldc_i4_5, "ldc.i4_5", OpCodeArg.None),
            new ILInstruction(ILOpCode.Ldc_i4_6, "ldc.i4_6", OpCodeArg.None),
            new ILInstruction(ILOpCode.Ldc_i4_7, "ldc.i4_7", OpCodeArg.None),
            new ILInstruction(ILOpCode.Ldc_i4_8, "ldc.i4_8", OpCodeArg.None),
...
//new ILInstruction(ILOpCode.Ldind_u8, "ldind.u8", OpCodeArg.None),
            ...
            new ILInstruction(ILOpCode.Ldloc_0, "ldloc_0", OpCodeArg.None),
            new ILInstruction(ILOpCode.Ldloc_1, "ldloc_1", OpCodeArg.None),
            new ILInstruction(ILOpCode.Ldloc_2, "ldloc_2", OpCodeArg.None),
            new ILInstruction(ILOpCode.Ldloc_3, "ldloc_3", OpCodeArg.None),
...
//new ILInstruction(ILOpCode.No_nullcheck, "no.nullcheck", OpCodeArg.None),
            ...
            new ILInstruction(ILOpCode.Stloc_0, "stloc_0", OpCodeArg.None),
            new ILInstruction(ILOpCode.Stloc_1, "stloc_1", OpCodeArg.None),
            new ILInstruction(ILOpCode.Stloc_2, "stloc_2", OpCodeArg.None),
            new ILInstruction(ILOpCode.Stloc_3, "stloc_3", OpCodeArg.None),
